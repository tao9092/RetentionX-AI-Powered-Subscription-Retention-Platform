...
<style scoped>
.data-page{display:grid;gap:17px;width:min(100%,1540px);margin:0 auto;padding:24px 26px 42px}.page-intro,.panel-heading,.dataset-actions{display:flex;align-items:flex-end;justify-content:space-between;gap:20px}.eyebrow{display:block;color:var(--rx-primary);font-size:8px;font-weight:900;text-transform:uppercase;letter-spacing:.14em}h2{margin:8px 0 7px;color:var(--rx-ink);font-size:clamp(25px,3vw,34px);letter-spacing:-.05em}.page-intro p,.dataset-actions p{max-width:650px;margin:0;color:var(--rx-muted);font-size:10px;line-height:1.55}.source-chip{min-width:215px;padding:11px 13px;border:1px solid var(--rx-border);border-radius:13px;background:#fff;box-shadow:var(--rx-shadow-sm)}.source-chip span,.source-chip strong,.source-chip small{display:block}.source-chip span{color:#9ca1a9;font-size:7px;font-weight:850;text-transform:uppercase}.source-chip strong{margin-top:5px;overflow:hidden;color:#373c43;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.source-chip small{margin-top:3px;color:var(--rx-success);font-size:8px}.data-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.panel{border:1px solid var(--rx-border);border-radius:19px;background:#fff;box-shadow:var(--rx-shadow-sm)}.upload-panel,.quality-panel,.preview-panel,.dataset-actions{padding:18px}.panel-heading{align-items:flex-start}.panel-heading h3,.dataset-actions h3{margin:5px 0 0;color:#30343a;font-size:13px}.text-button{border:0;color:var(--rx-primary);background:transparent;font-size:8px;font-weight:850;cursor:pointer}.drop-zone{display:grid;place-items:center;margin-top:14px;padding:30px 20px;border:1px dashed #cfd2d7;border-radius:16px;background:#fafafb;text-align:center;cursor:pointer;transition:.16s ease}.drop-zone.active,.drop-zone:hover{border-color:var(--rx-primary);background:#f7f5ff}.drop-zone input{display:none}.upload-icon{display:grid;place-items:center;width:45px;height:45px;border-radius:14px;color:#fff;background:var(--rx-primary);font-size:21px}.drop-zone strong{margin-top:12px;color:#3c4148;font-size:11px}.drop-zone p{max-width:430px;margin:6px 0 0;color:#979ca5;font-size:8.5px;line-height:1.5}.browse-pill{margin-top:12px;padding:7px 10px;border:1px solid var(--rx-border-strong);border-radius:8px;color:#555b64;background:#fff;font-size:8px;font-weight:850}.schema-note{margin-top:12px;padding:12px;border:1px solid #e6e3fb;border-radius:12px;background:#f8f7ff}.schema-note strong{color:#5147a8;font-size:9px}.schema-note p{margin:5px 0 0;color:#8680ad;font-size:8px;line-height:1.5}.panel-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:13px}.primary-button,.secondary-button,.danger-button{min-height:35px;padding:0 11px;border-radius:9px;font-size:8px;font-weight:850;cursor:pointer}.primary-button{border:0;color:var(--rx-lime-ink);background:var(--rx-lime)}.primary-button:disabled{opacity:.45;cursor:not-allowed}.secondary-button{border:1px solid var(--rx-border-strong);color:#555c65;background:#fff}.danger-button{border:1px solid #f2cbd3;color:var(--rx-danger);background:var(--rx-danger-soft)}.quality-badge{padding:6px 8px;border:1px solid var(--rx-border);border-radius:8px;color:#8b919a;background:#f7f7f8;font-size:7px;font-weight:850;text-transform:uppercase}.quality-badge.ready{color:var(--rx-success);border-color:#c7e7dc;background:var(--rx-success-soft)}.quality-score{display:grid;grid-template-columns:auto 1fr;gap:16px;align-items:center;margin-top:16px}.score-ring{position:relative;display:grid;place-items:center;width:92px;height:92px;border-radius:50%;background:conic-gradient(var(--rx-success) var(--score),#eceef0 0)}.score-ring:before{content:'';position:absolute;width:68px;height:68px;border-radius:50%;background:#fff}.score-ring span{position:relative;z-index:1;text-align:center}.score-ring strong,.score-ring small{display:block}.score-ring strong{color:#30343a;font-size:20px}.score-ring small{margin-top:3px;color:#9ba0a8;font-size:7px;text-transform:uppercase}.quality-score>div:last-child>strong{color:#3a3f46;font-size:10px}.quality-score p{margin:5px 0 0;color:#959ba4;font-size:8.5px;line-height:1.5}.quality-metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin-top:14px}.quality-metrics>div{padding:10px;border:1px solid var(--rx-border);border-radius:10px}.quality-metrics span,.quality-metrics strong{display:block}.quality-metrics span{color:#9ca1aa;font-size:7px;text-transform:uppercase}.quality-metrics strong{margin-top:6px;color:#3d4249;font-size:10px}.issue-box{margin-top:12px;padding:12px;border:1px solid var(--rx-border);border-radius:12px;background:#fafafb}.issue-heading{display:flex;justify-content:space-between;color:#4d535b;font-size:9px}.issue-heading span{display:grid;place-items:center;min-width:22px;height:20px;border-radius:7px;color:var(--rx-danger);background:var(--rx-danger-soft);font-size:7px}.issue-box ul{display:grid;gap:6px;margin:9px 0 0;padding:0;list-style:none}.issue-box li{color:#7f858e;font-size:8px}.issue-box li span{margin-right:7px;color:var(--rx-danger);font-weight:850}.issue-box p,.issue-box small{margin:8px 0 0;color:#959ba4;font-size:8px}.preview-panel{overflow:hidden;padding:0}.preview-panel .panel-heading{padding:18px}.preview-panel .panel-heading>span{color:#9ca1a9;font-size:8px}.preview-table{overflow-x:auto}.preview-row{display:grid;grid-template-columns:1.25fr .65fr .7fr .65fr .7fr 1.25fr;gap:10px;align-items:center;min-width:760px;padding:11px 18px;border-top:1px solid #eff0f2;color:#5d646d;font-size:8.5px}.preview-row.header{color:#9ba0a8;background:#fafafb;font-size:7px;font-weight:850;text-transform:uppercase}.preview-row strong,.preview-row small{display:block}.preview-row strong{color:#343940}.preview-row small{margin-top:3px;color:#9ca1a9}.preview-row .high{color:var(--rx-danger)}.preview-row .medium{color:var(--rx-warning)}.preview-row .low{color:var(--rx-success)}.empty-preview{padding:46px;color:#979ca5;text-align:center;font-size:9px}.dataset-actions{align-items:center}.dataset-actions>div:last-child{display:flex;gap:8px}.disclaimer{margin:0 3px;color:#9ba0a9;font-size:8px;line-height:1.5}@media(max-width:1000px){.data-grid{grid-template-columns:1fr}}@media(max-width:700px){.data-page{padding:17px 14px 30px}.page-intro,.dataset-actions{align-items:flex-start;flex-direction:column}.source-chip{width:100%}.quality-metrics{grid-template-columns:1fr 1fr}.dataset-actions>div:last-child{width:100%}.dataset-actions button{flex:1}}
</style>