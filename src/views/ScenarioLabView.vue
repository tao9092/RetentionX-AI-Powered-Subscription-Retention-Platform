...
<style scoped>
.scenario-page{display:grid;gap:17px;width:min(100%,1540px);margin:0 auto;padding:24px 26px 42px}.page-intro{display:flex;align-items:flex-end;justify-content:space-between;gap:20px}.eyebrow{display:block;color:var(--rx-primary);font-size:8px;font-weight:900;text-transform:uppercase;letter-spacing:.14em}h2{margin:8px 0 7px;color:var(--rx-ink);font-size:clamp(25px,3vw,34px);letter-spacing:-.05em}.page-intro p{max-width:660px;margin:0;color:var(--rx-muted);font-size:10px;line-height:1.55}.customer-select{min-width:240px;padding:10px 12px;border:1px solid var(--rx-border);border-radius:13px;background:#fff;box-shadow:var(--rx-shadow-sm)}.customer-select span{display:block;color:#9aa0a8;font-size:7px;font-weight:850;text-transform:uppercase}.customer-select select{width:100%;margin-top:5px;border:0;outline:0;color:#363b42;background:transparent;font-size:10px;font-weight:800}.customer-banner{display:grid;grid-template-columns:minmax(220px,1fr) minmax(330px,1fr) auto;gap:16px;align-items:center;padding:16px 18px;border:1px solid var(--rx-border);border-radius:18px;background:#fff;box-shadow:var(--rx-shadow-sm)}.customer-identity{display:flex;align-items:center;gap:11px}.avatar{display:grid;place-items:center;width:43px;height:43px;border-radius:13px;color:#4f41b8;background:var(--rx-primary-soft);font-size:10px;font-weight:900}.customer-identity small,.customer-identity h3,.customer-identity p{display:block;margin:0}.customer-identity small{color:#999fa8;font-size:8px}.customer-identity h3{margin-top:3px;color:#2e3238;font-size:13px}.customer-identity p{margin-top:3px;color:#838a93;font-size:8px}.baseline-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.baseline-metrics>div{padding:10px;border-left:1px solid #eff0f2}.baseline-metrics span,.baseline-metrics strong{display:block}.baseline-metrics>div>span{margin-bottom:7px;color:#9ca1a9;font-size:7px;font-weight:850;text-transform:uppercase}.baseline-metrics strong{color:#393e45;font-size:10px}.customer-banner>button{min-height:36px;padding:0 11px;border:1px solid var(--rx-border-strong);border-radius:10px;color:#4f555e;background:#fafafb;font-size:8px;font-weight:850;cursor:pointer}.lab-layout{display:grid;grid-template-columns:minmax(300px,.78fr) minmax(0,1.22fr);gap:14px}.panel{border:1px solid var(--rx-border);border-radius:19px;background:#fff;box-shadow:var(--rx-shadow-sm)}.panel-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:18px 18px 12px}.panel-heading h3,.result-heading h3{margin:5px 0 0;color:#30343a;font-size:13px}.directional-chip{padding:6px 8px;border:1px solid #dedafb;border-radius:8px;color:#584cbd;background:var(--rx-primary-soft);font-size:7px;font-weight:850}.scenario-list{padding-bottom:9px}.scenario-option{position:relative;display:grid;grid-template-columns:auto 1fr auto;gap:10px;align-items:center;width:calc(100% - 18px);margin:0 9px 6px;padding:11px;border:1px solid transparent;border-radius:12px;color:inherit;background:transparent;text-align:left;cursor:pointer}.scenario-option:hover{background:#f8f8fa}.scenario-option.active{border-color:#d8d2fb;background:#f7f5ff}.scenario-option.best{box-shadow:inset 3px 0 0 var(--rx-lime)}.scenario-option.unavailable{opacity:.45;cursor:not-allowed}.option-radio{display:grid;place-items:center;width:20px;height:20px;border:1px solid #d4d7dc;border-radius:50%;background:#fff}.option-radio i{width:8px;height:8px;border-radius:50%}.scenario-option.active .option-radio{border-color:var(--rx-primary)}.scenario-option.active .option-radio i{background:var(--rx-primary)}.option-copy strong,.option-copy small{display:block}.option-copy strong{color:#383d44;font-size:9.5px}.option-copy small{margin-top:3px;color:#959ba4;font-size:8px;line-height:1.4}.best-chip,.risk-change{padding:5px 7px;border-radius:7px;font-size:7px;font-weight:900}.best-chip{color:var(--rx-lime-ink);background:var(--rx-lime)}.risk-change{color:var(--rx-success);background:var(--rx-success-soft)}.result-panel{padding:19px;background:radial-gradient(circle at 100% 0%,rgba(102,86,232,.08),transparent 28%),#fff}.result-heading{display:flex;justify-content:space-between;gap:12px}.result-heading p{margin:6px 0 0;color:#878e97;font-size:8.5px;line-height:1.5}.strategy-icon{display:grid;place-items:center;width:38px;height:38px;border-radius:12px;color:var(--rx-lime-ink);background:var(--rx-lime)}.risk-comparison{display:grid;grid-template-columns:1fr auto 1fr;gap:12px;align-items:center;margin-top:18px}.risk-value{padding:14px;border:1px solid var(--rx-border);border-radius:14px;background:#fafafb}.risk-value span,.risk-value strong{display:block}.risk-value span{color:#9ba0a9;font-size:7px;font-weight:850;text-transform:uppercase}.risk-value strong{margin-top:7px;color:#33383f;font-size:22px}.risk-value>div{height:6px;margin-top:10px;overflow:hidden;border-radius:99px;background:#e9ebee}.risk-value i{display:block;height:100%;border-radius:inherit}.baseline i{background:var(--rx-danger)}.projected i{background:var(--rx-success)}.arrow{color:#a3a8b0;font-size:18px}.impact-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:12px}.impact-grid>div{padding:11px;border:1px solid var(--rx-border);border-radius:11px}.impact-grid span,.impact-grid strong{display:block}.impact-grid span{color:#9da2aa;font-size:7px;text-transform:uppercase}.impact-grid strong{margin-top:6px;color:#40464e;font-size:9px}.positive{color:var(--rx-success)!important}.negative{color:var(--rx-danger)!important}.execution-plan{margin-top:13px;padding:13px;border:1px solid #e5e2fb;border-radius:13px;background:#f8f7ff}.execution-heading{display:flex;justify-content:space-between;color:#5146ac;font-size:8px;font-weight:850}.execution-heading small{color:#8d85bd}.execution-plan ol{display:grid;gap:7px;margin:10px 0 0;padding:0;list-style:none}.execution-plan li{display:flex;gap:8px;color:#666d76;font-size:8.5px}.execution-plan li i{display:grid;place-items:center;width:17px;height:17px;flex:0 0 auto;border-radius:6px;color:var(--rx-lime-ink);background:var(--rx-lime);font-size:7px;font-style:normal}.result-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:14px}.primary-button,.secondary-button{min-height:36px;padding:0 11px;border-radius:10px;font-size:8px;font-weight:850;cursor:pointer}.primary-button{border:0;color:var(--rx-lime-ink);background:var(--rx-lime)}.secondary-button{border:1px solid var(--rx-border-strong);color:#555b64;background:#fff}.comparison-panel{overflow:hidden}.comparison-table{overflow-x:auto}.comparison-row{display:grid;grid-template-columns:1.2fr repeat(5,.8fr);gap:10px;align-items:center;min-width:760px;width:100%;padding:11px 18px;border:0;border-top:1px solid #eff0f2;color:#59606a;background:#fff;text-align:left;font-size:8.5px;cursor:pointer}.comparison-row.header{color:#9ba0a8;background:#fafafb;font-size:7px;font-weight:850;text-transform:uppercase;cursor:default}.comparison-row.active{background:#f7f5ff}.comparison-row strong{color:#353a41}.disclaimer{margin:0 3px;color:#9ba0a9;font-size:8px;line-height:1.5}@media(max-width:1000px){.lab-layout{grid-template-columns:1fr}.customer-banner{grid-template-columns:1fr}.baseline-metrics>div:first-child{padding-left:0;border-left:0}}@media(max-width:700px){.scenario-page{padding:17px 14px 30px}.page-intro{align-items:flex-start;flex-direction:column}.customer-select{width:100%}.baseline-metrics,.impact-grid{grid-template-columns:1fr 1fr}.risk-comparison{grid-template-columns:1fr}.arrow{transform:rotate(90deg);text-align:center}}
</style>